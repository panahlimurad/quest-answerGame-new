$(document).ready(function () {
    ...
    const CSS = [
      ...
      },
      {
        ...
        optins_a:
          "It represents the amount of text contained within an element.",
    ...
    const JavaScript = [
      {
        question: "JavaScript has a similar structure to which programming language?",
        optins_a: "JAVA",
        optins_b: "PYTHON",
        optins_c: "C++",
        optins_d: "HTML",
      ...
      },
      {
        ...
        optins_a: "for loop is repeated a specific number of times, while while loop is repeated based on a specific condition.",
    ...
    const webDesignUserExperience = [
      ...
      },
      {
        ...
        optins_c:
          "It means a design that looks good only in a specific browser.",
        optins_d:
